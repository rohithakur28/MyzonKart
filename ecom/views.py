...
def view_customer_view(request):
    ...
    user_form = forms.CustomerUserForm(instance=request.user)
    customer_form = forms.CustomerForm(instance=customer)

    if request.method == 'POST':
        user_form = forms.CustomerUserForm(request.POST, instance=request.user)
    ...
    return render(request, 'ecom/view_customer.html', {'userForm': user_form, 'customerForm': customer_form})
